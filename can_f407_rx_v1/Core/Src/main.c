...
int main(void)
{
  ...
  pRxHeader.DLC = 1; //give message size of 1 byte
  	...
  	pRxHeader.StdId = 0x0; //define a standard identifier, used for message identification by filters (switch this for the other microcontroller)
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan){
	HAL_CAN_GetRxMessage (&hcan1, RxFifo, &pRxHeader, RxData);
	HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_12);
	 HAL_UART_Transmit(&huart2, RxData,8,1000);
}
